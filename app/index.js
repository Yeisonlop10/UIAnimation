...
class MusicApp extends Component {
    constructor(){
        ...
        // We will set the animate value
        this.buttonOpacity = new Value(1)
        // Handle onStateChange method
        ...
        // Handle animations when button is clicked it goes down
        this.buttonY = interpolate(this.buttonOpacity, {
            inputRange:[0,1],
            outputRange:[100,0],
            extrapolate: Extrapolate.CLAMP // They don't interpolate between them
        });

        // Animte the background upwards
        ...
        // Animate signin text
        this.textInputZ = interpolate(this.buttonOpacity, {
            inputRange:[0,1],
            outputRange:[1, -1],
            extrapolate: Extrapolate.CLAMP // They don't interpolate between them
        });
